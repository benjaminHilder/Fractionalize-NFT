...
var alertAnatomy = themeTools.anatomy("alert").parts("title", "description", "container").extend("icon", "spinner");
/**
 * **Avatar anatomy**
...
var editableAnatomy = themeTools.anatomy("editable").parts("preview", "input", "textarea");
