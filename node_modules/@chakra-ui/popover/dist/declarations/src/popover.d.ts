...
export declare const PopoverAnchor: {
    (props: React.PropsWithChildren<{}>): React.DetailedReactHTMLElement<import("@chakra-ui/utils").Omit<import("@chakra-ui/react-utils").HTMLProps<any>, never>, HTMLElement>;
    displayName: string;
};
/**
...
export declare const PopoverCloseButton: import("@chakra-ui/system").ComponentWithAs<"button", CloseButtonProps>;
