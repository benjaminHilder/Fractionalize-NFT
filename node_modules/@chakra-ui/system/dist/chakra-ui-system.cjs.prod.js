...
var allPropNames = new Set([].concat(styledSystem.propNames, ["textStyle", "layerStyle", "apply", "noOfLines", "focusBorderColor", "errorBorderColor", "as", "__css", "css", "sx"]));
/**
...
function useStyleConfigImpl(themeKey, props) {
  ...
  if (styleConfig) {
    var getStyles = styledSystem.resolveStyleConfig(styleConfig);
