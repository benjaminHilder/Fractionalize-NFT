...
var foundations_sizes_dist_chakraUiThemeFoundationsSizes = require('../../dist/sizes-8458a9c4.cjs.prod.js');
...
function getSize$3(size) {
  var themeSize = size !== "100%" ? foundations_sizes_dist_chakraUiThemeFoundationsSizes.sizes[size] : undefined;
  return {
    container: {
      width: size,
      height: size,
...
function getSize(size) {
  ...
  var fontSize = foundations_typography_dist_chakraUiThemeFoundationsTypography["default"].fontSizes[_fontSize];
  return {
